...
export async function collect() {
  ...
  // Andamento del titolo in Borsa (fine giornata). Difensivo: se fallisce,
  // market = null e il widget non viene mostrato.
  const market = await getMarket();

  return { edition, digest: dailyDigest, topStory, articles: stories, market };
}
