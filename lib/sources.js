...
// Indizi che "Lazio" è la REGIONE, non la squadra. Trucco linguistico: la
// squadra è femminile ("la Lazio", "della Lazio", "alla Lazio"); la regione è
// maschile o senza articolo ("il Lazio", "nel Lazio", "del Lazio", "in Lazio").
// Se compaiono queste forme E manca un segnale calcistico forte, la notizia
// parla del territorio (meteo, cronaca, viabilità) e va scartata.
